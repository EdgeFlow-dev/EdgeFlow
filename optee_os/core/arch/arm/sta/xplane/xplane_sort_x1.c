...
void x1_inregister_sort(int32_t *input, int32_t *output, __unused uint32_t cmp){
...
void x1_merge4_eqlen_aligned(int32_t * const inpA, int32_t * const inpB,
		int32_t * const out, const uint32_t lenA, const uint32_t lenB, __unused uint32_t cmp)
{
...
void x1_merge8_varlen_aligned(int32_t * restrict inpA, int32_t * restrict inpB, int32_t * restrict Out,
		const uint32_t lenA, const uint32_t lenB, __unused uint32_t cmp)
{
