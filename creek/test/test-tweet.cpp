...
//  					TXT_TWEETS
	 ...
	 // create a new pipeline
	  ...
	  WinMapper<string_range, long, BundleT> mapper("winmapper", 1000 * 1000 /* seconds(1) */);
...
void tweet_2streams()
{
  ...
  WinMapper<string_range, long, BundleT> mapper0("winmapper", 1000 * 1000 /* seconds(1) */);
...
//	RecordBundleSink<long> sink0("sink");
  RecordBundleSink<creek::tvpair> sink0("sink");
	...
	WinMapper<string_range, long, BundleT> mapper1("winmapper", 1000 * 1000 /* seconds(1) */);
...
static void test_2streams_join()
{
	UnboundedInMem<string_range, BundleT>
	  ...
	  agg0.set_side_info(SIDE_INFO_L);
		...
		Join<pair<long,long>, RecordBundle, RecordBundle> join("[join]", 1000 * 1000 /* seconds(1) */);
...
static void test_wc_tvpair()
{
  ...
  WinGBK<pair<creek::string, long>, BundleT,
  					WinKeyFragLocal_Std> wgbk ("[wingbk]", 1000 * 1000 /* seconds(1) */);
