...
#		"disable" : True	# XXX skip the test
	...
	{
		"name" : "test-winsum-long",
		"exec" : "./test-winsum-long.bin",
		"records" : 1000 * 1000,		# records per epoch
		"record_size" : 8,		# long
		"target_ms" : 50,
		"input_file" : "/ssd/integers-100M.txt",
		# --- optional --- #
		# "cores" : 54,   # if unspecified, fall back to app default
		"tput_baseline" : 20000, # used to be compared with the test results
		"tput_hint" : 20000,  # the throughput value that test should try first
		# --- control --- #
		#		"disable" : True	# XXX skip the test
	},
]	
