/*
 *
 * Creator: xzl. Purdue University, 2016.
 *
 * new implementation based on the container interface
 */
...
//		etime in_min_ts = trans->RetrieveState(&winmap, purge, up_wm);  // old impl.
		etime in_min_ts = trans->RetrieveState(&winmap, up_wm, up_wm);
