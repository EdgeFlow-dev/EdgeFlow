...
/* included in all WinKeyReducerEval-wc-xxxx */

#ifndef CREEK_WINKEYREDUCEREVAL_WC_COMMON_H_H
#define CREEK_WINKEYREDUCEREVAL_WC_COMMON_H_H
...
#endif //CREEK_WINKEYREDUCEREVAL_WC_COMMON_H_H
