...
/* used to calculate records per interval, if it is unspecified
 * can be overriden if bundles_per_epoch (wm frequency) is explicitly configured
 * */
#define CONFIG_DEFAULT_BUNDLE_SIZE	(1000u * 100u)
