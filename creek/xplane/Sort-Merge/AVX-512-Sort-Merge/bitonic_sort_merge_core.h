 ...
 * Date: Nov 9th, 2017 
 * Description: This file provides Bitonic sort/merge core functions for AVX-512 
 * */

#ifndef BITONIC_SORT_MERGE_CORE_H
#define BITONIC_SORT_MERGE_CORE_H 
#include <immintrin.h>
#include <cstdint>
/* List of Functions: these functions are in bitonic_sort_merge_core.cpp */
...
//these functions are in sort_merge.cpp
...
void merge_8_unaligned(int64_t* input1_k, int64_t* input2_k, int64_t* output_k, int len1, int len2);
...
void bitonic_sort_avx512_8x8(int64_t* ptr){
	...
	r0 = _mm512_loadu_pd ((int64_t const *)(ptr));
	r1 = _mm512_loadu_pd ((int64_t const *)(ptr + 8));
	r2 = _mm512_loadu_pd ((int64_t const *)(ptr + 16));
	r3 = _mm512_loadu_pd ((int64_t const *)(ptr + 24));
	r4 = _mm512_loadu_pd ((int64_t const *)(ptr + 32));
	r5 = _mm512_loadu_pd ((int64_t const *)(ptr + 40));
	r6 = _mm512_loadu_pd ((int64_t const *)(ptr + 48));
	r7 = _mm512_loadu_pd ((int64_t const *)(ptr + 56));
	...
	_mm512_storeu_pd ((int64_t *) ptr, t0);
	_mm512_storeu_pd ((int64_t *) (ptr + 8), t1);
	_mm512_storeu_pd ((int64_t *) (ptr + 16), t2);
	_mm512_storeu_pd ((int64_t *) (ptr + 24), t3);
	_mm512_storeu_pd ((int64_t *) (ptr + 32), t4);
	_mm512_storeu_pd ((int64_t *) (ptr + 40), t5);
	_mm512_storeu_pd ((int64_t *) (ptr + 48), t6);
	_mm512_storeu_pd ((int64_t *) (ptr + 56), t7);
}
...
#endif /* BITONIC_SORT_MERGE_CORE_H */
