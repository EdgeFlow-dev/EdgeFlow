...
private:
    ...
    static boost::posix_time::ptime last_check;
...
template<class T>
boost::posix_time::ptime RecordBitmapBundleSink<T>::last_check = boost::posix_time::microsec_clock::local_time();
template<class T>
boost::posix_time::ptime RecordBitmapBundleSink<T>::start_time = boost::posix_time::microsec_clock::local_time();;
